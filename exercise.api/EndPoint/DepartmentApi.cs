...
namespace exercise.api.EndPoint
{
    public static class DepartmentApi
    {
        ...
        public static async Task<IResult> GetDepartments(IEmployeeRepository repository)
        {
            try
            {
        ...
        public static async Task<IResult> DeleteDepartment(IEmployeeRepository repository, int id)
        {
            try
            {
        ...
        public static async Task<IResult> GetDepartment(IEmployeeRepository repository, int id)
        {
            try
            {
        ...
        public static async Task<IResult> AddDepartment(IEmployeeRepository repository, Department department)
        {
            try
            {
        ...
        public static async Task<IResult> UpdateDepartment(IEmployeeRepository repository, Department department)
        {
            try
            {
